          ...
          {navLinks.map((link) => (
            <li key={link.label}>
              <Link
                href={link.href}
                className={cn(
                  "px-3 py-2 rounded-md text-sm font-medium tracking-wide text-muted-foreground hover:text-primary transition-all",
        ...
        <DropdownMenu>
          ...
          >
            {navLinks.map((link) => (
              <DropdownMenuItem
                className={cn(
                  "text-primary font-medium tracking-widest focus:bg-transaprent",
